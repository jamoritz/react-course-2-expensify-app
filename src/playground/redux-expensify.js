    ...
    expenses: [
        {
            ...
            amount: 54500, // dollars and cents in pennies
            createdAt: 0
        }
    ],
    filters: {
...
// Reducer actions that we need to create:
// ADD_EXPENSE
...
// We will create a single reducer for each single root property in our redux store
...
// timestamps - time in milliseconds from midnight Jan 1st 1970 (unix epoch)
// valid timestamps: 33400, 10, -283
...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 100, createdAt: 1000 })); // $1.00
const expenseTwo = store.dispatch(addExpense({ description: 'Coffee', amount: 300, createdAt: -1000 })); // $3.00
